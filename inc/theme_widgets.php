<?php
	...
	register_sidebar(array(
	  'name' => esc_html__( 'Default Sidebar', 'myPersonalinfo' ),
	  'id' => 'sidebar-left',
	  'description' => esc_html__( 'Widgets in this area will be shown on the right-hand side.', 'myPersonalinfo' ),
	...
	//Default Footer Sidebar
	  register_sidebar(array(
		  'name' => esc_html__( 'Main Footer Sidebar', 'myPersonalinfo' ),
		  'id' => 'footer-sidebar',
		  'description' => esc_html__( 'Widgets in this area will be shown in Footer Area.', 'myPersonalinfo' ),
