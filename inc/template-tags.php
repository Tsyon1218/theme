...
if ( ! function_exists( 'myPersonalinfo_comments_number' ) ) :
	/**
	 * Prints HTML with meta information for the current author.
	 */
	function myPersonalinfo_comments_number() {?>				
...
if ( ! function_exists( 'myPersonalinfo_meta_info' ) ) :
	/**
	 * Prints HTML with meta information for the categories, tags and comments.
	 */
	function myPersonalinfo_meta_info() {
		// Hide category and tag text for pages.
			...
			if (is_single()) {
				...
				myPersonalinfo_comments_number();
...
if ( ! function_exists( 'myPersonalinfo_post_thumbnail' ) ) :
	...
	function myPersonalinfo_post_thumbnail() {
		...
		if ( is_singular() ) :
			...
			<div class="image">
				<?php the_post_thumbnail('myPersonalinfo-landscape'); ?>
			</div><!-- .post-thumbnail -->
...
<div class="image">
		<a class="overlay-link" href="<?php the_permalink(); ?>" aria-hidden="true" tabindex="-1">
			<?php
			the_post_thumbnail( 'myPersonalinfo-landscape', array(
